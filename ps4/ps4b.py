...
class Message(object):
    def __init__(self, text):
        ...
        self.__valid_words = load_words("words.txt")
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(len(lower_case)):
            ...
            if new_letter >= 26:
                new_letter %= 26
            shift_dict[lower_case[i]] = lower_case[new_letter]
        for i in range(len(upper_case)):
            new_letter = i + shift
            if new_letter >= 26:
                new_letter %= 26
            shift_dict[upper_case[i]] = upper_case[new_letter]
        return shift_dict
...
class PlaintextMessage(Message):
    ...
    def get_encryption_dict(self):
        ...
        '''
        return self.__encryption_dict.copy()
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for s in range(1,26):
            ...
            words_list = new_message.split()
            for words in words_list:
                if is_word(self.get_valid_words(),words):
                    words_matched += 1
            if words_matched > highest_matched:
                highest_matched = words_matched
                best_shift = s
            words_matched = 0
...
if __name__ == '__main__':
   ...
   #Example test case (PlaintextMessage)
    ...
    story_msg = get_story_string()
    decrypted_story = CiphertextMessage(story_msg)
